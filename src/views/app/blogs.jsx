            ...
            <Grid>
              <Row>
                <Col xs={12}>
                    ...
                    <Row>
                      <Col xs={6} collapseLeft collapseRight>
                        <div className='fg-darkgray50'>
                          <small>by <Link to='/single_post'>{this.props.author}</Link> / {this.props.date}</small>
                        </div>
                      </Col>
                  ...
                  <p>
                    <Link to='/single_post'>Read More</Link>
                  </p>
                </Col>
              </Row>
            </Grid>
              ...
              <Grid>
                <Row>
                  <Col xs={12}>
                    ...
                    <BlogSummary
                      img='/imgs/images/gallery/tumblr_n7fgnop0bz1st5lhmo1_1280.jpg'
                    ...
                    <BlogSummary
                      img='/imgs/images/gallery/tumblr_n9hyk7kMxc1st5lhmo1_1280.jpg'
                          ...
                          <Row>
                            <Col xs={12} className='text-center'>
                              <div className='text-left'>
                                ...
                                <div style={{marginBottom: 12.5}}>
                                  <Link to='/blog'><LoremIpsum className='text-capitalize' query='3w'/></Link>
