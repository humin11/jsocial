...
var paths = {
  ...
  scss: ['public/fonts/web/*.ttf', 'src/views/sass/*.scss', 'src/views/sass/**/*.scss', 'src/views/sass/**/**/*.scss',
      'src/views/sass/**/**/**/*.scss', 'src/views/sass/**/**/**/**/*.scss', 'src/views/global/sass/*.scss',
      'src/views/global/sass/**/*.scss', 'src/views/global/sass/**/**/*.scss',
      'src/views/global/sass/**/**/**/*.scss', 'src/views/global/sass/**/**/**/**/*.scss'],
  bootstrap: ['src/views/global/vendor/bootstrap/*.jsx'],
  ttf: ['public/fonts/dropbox/*.ttf']
};
...
gulp.task('react:react-l20n', function() {
  return gulp.src('./src/views/global/vendor/l20n/index.jsx')
          .pipe(webpack({
            cache: true,
            module: {
              loaders: [
...
gulp.task('react:react-bootstrap', function() {
  return gulp.src('./src/views/global/vendor/bootstrap/index.jsx')
          .pipe(webpack({
            cache: true,
            module: {
              loaders: [
...
gulp.task('react:concat', ['react:app'], function() {
  return gulp.src(['src/views/global/requires/*.js', 'public/js/'+defaultAppName+'.js'])
...
gulp.task('base64-css:convert', function() {
  return gulp.src('public/fonts/dropbox/*.ttf')
          .pipe(ttf2woff())
          .pipe(cssfont64())
          ...
          .pipe(gulp.dest('prebuild/css/fonts'));
});

gulp.task('base64-css:concat', ['base64-css:convert'], function() {
  return gulp.src(['prebuild/css/fonts/*.css'])
          .pipe(insert.prepend('@charset "UTF-8";\n'))
